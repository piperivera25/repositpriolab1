...
public class StudentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idStr=request.getParameter("codEstudiantes");
        //int id=Integer.parseInt(idStr);
        
        String firstName=request.getParameter("nombreEstudiante");
        String lastName=request.getParameter("apellidoEstudiante");
        ...
        Estudiantes student=new Estudiantes(idStr,firstName,lastName,semestreEstudiante);
